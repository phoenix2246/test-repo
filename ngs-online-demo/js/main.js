...
const lightTheme = () => {
	moon.classList.remove("position-absolute", "d-none");
	sun.classList.add("position-absolute", "d-none");
}

const darkTheme = () => {
	sun.classList.remove("position-absolute", "d-none");
	moon.classList.add("position-absolute", "d-none");
}
...
$(document).ready(function () {
	$(".moon").click(function () {
		$(".ch-dl").removeClass("ls").addClass("ds");//ch-dl = change dark and light
	});

	$(".sun").click(function () {
		$(".ch-dl").removeClass("ds").addClass("ls");
	});
});

function changeNavColor(){
	var navBarBgcolor = document.querySelector(".page_header")
	var navScrollValue = window.scrollY;
	if(navScrollValue < 220){
		navBarBgcolor.classList.remove("ms");
	} else{
		navBarBgcolor.classList.add("ms");
	}
}
